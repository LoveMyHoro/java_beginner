package project3_斗地主.game;



import project3_斗地主.domain.User;
...
public class LoginJFrame extends JFrame implements MouseListener {
	...
	*/
    ...
    static{
        allUser.add(new User("明日香","1234"));
        allUser.add(new User("战场原","1234"));
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(obj==login){
            ...
            else if(Name.length()==0||word.length()==0){
            ...
            //判断集合中是否有这个用户
            User userInfo=new User(Name,word);
            //contains底层是依赖equals方法的，所以要对contains方法进行重写
