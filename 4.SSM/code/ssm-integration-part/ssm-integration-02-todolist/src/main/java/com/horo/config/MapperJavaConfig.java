 ...
 * @Author iove
 * @Date 2024/10/21 下午10:17
 * @Version 1.0
 * @Description TODO 这个是mapper层的配置类
 **/
@Configuration
public class MapperJavaConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean(DataSource dataSource){
        ...
        //typeAliases
        sqlSessionFactoryBean.setTypeAliasesPackage("com.horo.pojo");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer(){
        ...
        mapperScannerConfigurer.setBasePackage("com.horo.mapper");
